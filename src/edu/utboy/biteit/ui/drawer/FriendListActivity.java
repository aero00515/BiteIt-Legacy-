...
import edu.utboy.biteit.ui.adapters.FriendListItemAdapter;
import edu.utboy.biteit.utils.ListActivity;

public class FriendListActivity extends ListActivity {

	private static final int INITIAL_DELAY_MILLIS = 500;
	private FriendListItemAdapter mExpandableListItemAdapter;
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		friendDAO.open();
		mExpandableListItemAdapter = new FriendListItemAdapter(this,
				friendDAO);
